      ...
      try {
        ...
        if (data.participant) {
          setFormData({
            ...
            number: data.participant.number,
            description: data.participant.description || "",
        ...
        {fetching ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 animate-in fade-in">
                ...
                <div className="flex items-center space-x-4">
                  {formData.imageUrl && (
                    <div className="w-16 h-16 rounded-xl overflow-hidden relative border border-black/10 dark:border-white/10 shrink-0">
                      <picture>
                        <img src={formData.imageUrl.includes('dicebear') ? formData.imageUrl : formData.imageUrl} alt="Aperçu" className="w-full h-full object-cover" />
                      </picture>
                    </div>
                  )}
                  <input
              ...
              <div>
                <label className="block text-sm font-medium mb-2">Description / Présentation</label>
                <textarea
                  rows={4}
