      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="font-serif text-2xl font-bold text-accent drop-shadow-sm">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <Link href="/regles" className={`text-sm font-medium hover:text-accent transition-colors ${scrolled ? 'text-foreground/80' : 'text-white/90 drop-shadow-md'}`}>
              Les Règles
            </Link>
            <Link href="/#faq" className={`text-sm font-medium hover:text-accent transition-colors ${scrolled ? 'text-foreground/80' : 'text-white/90 drop-shadow-md'}`}>
              FAQ
            </Link>
            <Link href="/contact" className={`text-sm font-medium hover:text-accent transition-colors ${scrolled ? 'text-foreground/80' : 'text-white/90 drop-shadow-md'}`}>
              Contact
            </Link>
            <div className="pl-4">
      ...
      {isOpen && (
        <div className="lg:hidden bg-background border-b border-black/5 dark:border-white/10 shadow-2xl absolute w-full top-full left-0">
          <div className="px-4 pt-4 pb-8 flex flex-col space-y-4">
            ...
            <Link href="/regles" className="px-3 py-3 text-base font-medium rounded-lg hover:bg-black/5 dark:hover:bg-white/5 hover:text-accent" onClick={() => setIsOpen(false)}>
              Les Règles
            </Link>
            <Link href="/#faq" className="px-3 py-3 text-base font-medium rounded-lg hover:bg-black/5 dark:hover:bg-white/5 hover:text-accent" onClick={() => setIsOpen(false)}>
              FAQ
            </Link>
            <Link href="/contact" className="px-3 py-3 text-base font-medium rounded-lg hover:bg-black/5 dark:hover:bg-white/5 hover:text-accent" onClick={() => setIsOpen(false)}>
              Nous Contacter
            </Link>
            <div className="pt-6">
